...
def records_to_graph():
    ...
    for movie in movies.keys():
        for i in range(1,6):
            ...
            nodedict[movie+"_"+str(i)].id = count
            count = count + 1
